...
<ul>
  ...
  <li>
    Support for <code>DATABASE_MIRRORING_PARTNER</code> environment change notification.
  ...
  <li>
    Support for using <code>varchar(max)</code> and <code>nvarchar(max)</code> in parameterised statements.
